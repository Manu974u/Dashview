...
export const translations = {
  en: {
    ...
    settings: {
      ...
      cameraTitle: 'Camera',
      cameraDesc: 'Choose which camera(s) to record with',
      cameraBack: 'Road',
      cameraFront: 'Interior',
      cameraBoth: 'Both',
      cameraBothWarning: '⚠️ Both cameras doubles battery and storage usage',
      cameraFrontNote: 'Films the driver and passengers',
  ...
  fr: {
    ...
    settings: {
      ...
      cameraTitle: 'Caméra',
      cameraDesc: 'Choisissez quelle(s) caméra(s) utiliser',
      cameraBack: 'Route',
      cameraFront: 'Habitacle',
      cameraBoth: 'Les deux',
      cameraBothWarning: '⚠️ Les deux caméras double la batterie et le stockage',
